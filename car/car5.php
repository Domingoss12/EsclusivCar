...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="../automóveis.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-red-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Automóveis</a>
                    </li>
    ...
    <div class="px-5 max-w-screen-2xl mx-auto pt-7">
        <h1 class="text-4xl font-bold text-center">Peugeot 208</h1>
        <div class="grid grid-cols-5">
            <div class="grid col-span-3">
                <img class="h-auto max-w-full p-5 rounded-lg" src="../img/car5.jpg" alt="car5">
            </div>
            <div class="col-span-2 relative overflow-x-auto mt-5">
    ...
    <footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="index.html" class="hover:underline">ExclusivCar</a>. All Rights Reserved.
            </span>
        </div>
    </footer>
